...
import { LayoutDashboard, Map, BookOpen, BarChart3, Bell, Settings, User, ChevronLeft, ChevronRight } from 'lucide-react';
...
export function DashboardLayout({ children }) {
  ...
  return (<div className="min-h-screen flex flex-col">
    ...
    <div className="flex flex-1">
      {/* Sidebar - Desktop */}
      <motion.aside initial={false} animate={{ width: collapsed ? 72 : 240 }} className="hidden lg:flex flex-col border-r border-border bg-card">
